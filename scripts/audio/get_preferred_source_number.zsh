...
{ { pamixer --list-sources | grep -v "Monitor" | grep $name_1; } || { pamixer --list-sources | grep -v "Monitor" | grep $name_2; } || { pamixer --list-sources | grep -v "Monitor" | grep $name_3; } || { pamixer --list-sources | grep -v "Monitor" | grep $name_2; } || echo "0" } | head -1 | awk '{ print $1 }'
